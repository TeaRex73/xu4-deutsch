...
struct Spell {
	typedef enum {
		...
		PARAM_TYPEDIR, /* type of field and direction
				  required (energy field) */
	...
	typedef enum {
		SFX_NONE,       /* none */
		SFX_INVERT, /* invert the screen
			       (moongates, most normal spells) */
...
bool spellCast(unsigned int spell,
	       int character,
	       int param,
