	...
	for (i = 0; i < dungeon->n_rooms; i++) {
		...
		if (map->id == MAP_HYTHLOTH) {
			...
			if (i == 0x7) {
				...
				const unsigned char x1[8] = { 0x8, 0x8, 0x9, 0x9, 0x9, 0xA, 0xA, 0xA }, y1[8] = { 0x3, 0x2, 0x3, 0x2, 0x1, 0x3, 0x2, 0x1 };
				...
				const unsigned char x2[8] = { 0x3, 0x2, 0x3, 0x2, 0x1, 0x3, 0x2, 0x1 }, y2[8] = { 0x8, 0x8, 0x9, 0x9, 0x9, 0xA, 0xA, 0xA };
				...
				const unsigned char x1[3] = { 0x4, 0x6, 0x5 }, y1[3] = { 0x5, 0x5, 0x6 };
				...
				const unsigned char x2[8] = { 0x2, 0x2, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0 }, y2[8] = { 0x9, 0x8, 0x9, 0x8, 0x7, 0x9, 0x8, 0x7 };
				...
				const Coords tile[] = {
					...
					Coords(1, 7, 0x16), Coords(0, 8, 0x16), Coords(1, 8, 0x16), Coords(0, 9, 0x16)
				};
