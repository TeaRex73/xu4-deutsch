 ...
 */
typedef enum {
	MENU_OUTPUT_INT, MENU_OUTPUT_GAMMA, MENU_OUTPUT_SHRINE, MENU_OUTPUT_SPELL, MENU_OUTPUT_VOLUME, MENU_OUTPUT_REAGENT
} menuOutputType;
class MenuItem {
public: MenuItem(string text, short x, short y, int shortcutKey = -1);
virtual ~MenuItem() {}
...
public: BoolMenuItem(string text, short x, short y, int shortcutKey, bool *val);
...
public: StringMenuItem(string text, short x, short y, int shortcutKey, string *val, const vector<string> &validSettings);
virtual void activate(MenuEvent &event);
virtual string getText() const;
...
public: IntMenuItem(string text, short x, short y, int shortcutKey, int *val, int min, int max, int increment, menuOutputType output = MENU_OUTPUT_INT);
virtual void activate(MenuEvent &event);
virtual string getText() const;
protected: int *val;
