 ...
 */
class TileRule {
public: static TileRule *findByName(const string &name);
static void load();
 ...
 */
class Tileset {
public: typedef std::map<string, Tileset *> TilesetMap;
...
public: void load(const ConfigElement &tilesetConf);
void unload();
void unloadImages();
Tile *get(TileId id);
...
private: static TilesetMap tilesets;
string name;
TileIdMap tiles;
