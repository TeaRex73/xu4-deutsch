...
public:
	...
	list<string> getConversationText(Conversation *cnv,
					 const char *inquiry);
	...
	string talkerGetQuestionResponse(Conversation *cnv,
					 const char *inquiry);
	string beggarGetQuantityResponse(Conversation *cnv,
					 const char *response);
	string lordBritishGetQuestionResponse(Conversation *cnv,
					      const char *answer);
