 ...
 */
class IntroBinData {
public: const static int INTRO_TEXT_OFFSET;
...
//
enum AnimType {
	SIGNATURE, AND, BAR, ORIGIN, PRESENT, TITLE, SUBTITLE, MAP
};
struct AnimPlot {
	uint8_t x, y;
	uint8_t r, g, b, a;
