    ...
    for (ii = 0; ii < n; ii++) {
        for (y = (src->height() / n) * ii;
            ...
            for (x = 0; x < src->width(); x++) {
                ...
                // either diagonal around this side), take
                // the color of surrounding points in
                // this direction
                ...
                if (scale == 2) {
                    ...
                    dest->putPixel(
                        x * 2 + 1, y * 2 + 1, e3.r, e3.g, e3.b, e3.a
                    );
                } else if (scale == 3) {
                    ...
                    dest->putPixel(
                        x * 3 + 2, y * 3 + 1, e6.r, e6.g, e6.b, e6.a
                    );
                    dest->putPixel(x * 3, y * 3 + 2, e2.r, e2.g, e2.b, e2.a);
                    dest->putPixel(
                        x * 3 + 1, y * 3 + 2, e7.r, e7.g, e7.b, e7.a
                    );
                    dest->putPixel(
                        x * 3 + 2, y * 3 + 2, e3.r, e3.g, e3.b, e3.a
                    );
                }
            }
        }
