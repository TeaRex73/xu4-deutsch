...
string getChoices();
int getInputMaxLen();
private: void        translate(string *script);
 ...
 * Static variables
 */
private: typedef std::map<string, Action> ActionMap;
static ActionMap action_map;
private: void removeCurrentVariable(const string &name);
