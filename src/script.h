...
public:
	...
	ReturnCode execute(xmlNodePtr script,
...
private:
	...
	xmlNodePtr find(xmlNodePtr node,
			const string &script,
			const string &choice = "",
			bool _default = false);
	string getPropAsStr(std::list<xmlNodePtr> &nodes,
			    const string &prop,
			    bool recursive);
	string getPropAsStr(xmlNodePtr node,
			    const string &prop,
			    bool recursive = false);
	int getPropAsInt(std::list<xmlNodePtr> &nodes,
			 const string &prop,
			 bool recursive);
	int getPropAsInt(xmlNodePtr node,
			 const string &prop,
			 bool recursive = false);
	...
	void parseOperation(const string &str,
			    string *lval,
			    string *rval,
			    string *op);
...
private:
	...
	string inputName; /**< The variable in which to place
			     the input (by default, "input") */
	int inputMaxLen; /**< The maximum length allowed for input */
	string nounName; /**< The name that identifies a node name of noun
			    nodes */
	string idPropName; /**< The name of the property that uniquely
