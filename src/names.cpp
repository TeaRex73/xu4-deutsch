...
const char *getClassNameEnglish(ClassType klass)
{
	...
	case CLASS_TINKER: return "Tinker";
	case CLASS_PALADIN: return "Paladin";
	case CLASS_RANGER: return "Ranger";
	case CLASS_SHEPHERD: return "Shepherd";
	default: return "???";
	}
}
...
{
	switch (klass) {
	case CLASS_MAGE: switch (sex) {
		case SEX_MALE: return "Magier";
		case SEX_FEMALE: return "Magierin";
		default: return "???";
	}
	case CLASS_BARD: switch (sex) {
		case SEX_MALE: return "Barde";
		case SEX_FEMALE: return "Bardin";
		default: return "???";
	}
	case CLASS_FIGHTER: switch (sex) {
		case SEX_MALE: return "K{mpfer";
		case SEX_FEMALE: return "K{mpferin";
		default: return "???";
	}
	case CLASS_DRUID: switch (sex) {
		case SEX_MALE: return "Druide";
		case SEX_FEMALE: return "Druidin";
		default: return "???";
	}
	case CLASS_TINKER: switch (sex) {
		case SEX_MALE: return "Zinker";
		case SEX_FEMALE: return "Zinkerin";
		default: return "???";
	}
	case CLASS_PALADIN: switch (sex) {
		case SEX_MALE: return "Paladin";
		case SEX_FEMALE: return "Paladinin";
		default: return "???";
	}
	case CLASS_RANGER: switch (sex) {
		case SEX_MALE: return "Waldl{ufer";
		case SEX_FEMALE: return "Waldl{uferin";
		default: return "???";
	}
	case CLASS_SHEPHERD: switch (sex) {
		case SEX_MALE: return "Hirte";
		case SEX_FEMALE: return "Hirtin";
		default: return "???";
	}
	default: return "???";
	} // switch
...
const char *getReagentName(Reagent reagent)
{
	static const char *const reagentNames[] = {
		"Schwelasche", "Ginseng", "Knoblauch", "Spinnweben", "Blutmoos", "Schwarzperl", "Schatten", "Alraune"
	};
...
const char *getVirtueName(Virtue virtue)
{
	static const char *const virtueNames[] = {
		"Ehrlichkeit", "Mitgef}hl", "Tapferkeit", "Gerechtigkeit", "Verzicht", "Ehre", "Spiritualit{t", "Demut"
	};
...
const char *getVirtueAdjective(Virtue virtue)
{
	static const char *const virtueAdjectives[] = {
		"ehrlich", "mitf}hlend", "tapfer", "gerecht", "verzichtend", "ehrenvoll", "spirituell", "dem}tig"
	};
...
{
	static const char *const virtueNames[] = {
		"Blau", "Gelb", "Rot", "Gr}n", "Orange", "Violett", "Wei~", "Schwarz"
	};
...
{
	switch (item) {
	case ITEM_SKULL: return "SCH[DEL";
	case ITEM_CANDLE: return "KERZE";
	case ITEM_BOOK: return "BUCH";
	case ITEM_BELL: return "GLOCKE";
	case ITEM_KEY_C: return "MUT";
	case ITEM_KEY_L: return "LIEBE";
	case ITEM_KEY_T: return "WAHRHEIT";
	case ITEM_HORN: return "HORN";
	case ITEM_WHEEL: return "STEUER";
	default: return "???";
	}
}
