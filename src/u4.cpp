...
int main(int argc, char *argv[])
{
	...
	for (i = 1; i < (unsigned int)argc; i++) {
		if (((strcmp(argv[i], "-p") == 0) || (strcmp(argv[i], "-profile") == 0)) && ((unsigned int)argc > i + 1)) {
...
#endif
		else if (((strcmp(argv[i], "-p") == 0) || (strcmp(argv[i], "-profile") == 0)) && ((unsigned int)argc > i + 1)) {
			// do nothing
			i++;
