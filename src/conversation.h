 ...
 */
class Response {
public: Response(const string &response);
virtual ~Response() {}
...
public: DynamicResponse(Response *(*generator)(const DynamicResponse *), const string &param = "");
...
private: Response *(*generator)(const DynamicResponse *);
 ...
 */
class Question {
public: Question(const string &txt, Response *yes, Response *no);
string getText();
 ...
 */
class Keyword {
public: Keyword(const string &kw, Response *resp);
...
enum InputType {
	INPUT_STRING, INPUT_CHARACTER, INPUT_NONE
};
...
public: State state;            /**< The state of the conversation */
