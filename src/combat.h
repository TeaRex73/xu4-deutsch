...
class Weapon;
typedef enum {
	CA_ATTACK, CA_CAST_SLEEP, CA_ADVANCE, CA_RANGED, CA_FLEE, CA_TELEPORT
} CombatAction;
/**
...
public: CombatController(CombatMap *m);
...
bool showMessage;
Direction exitDir;
private: CombatController(const CombatController &);
...
// Properties
protected: bool dungeonRoom;
BaseVirtue altarRoom;
bool contextual;
public: Coords creature_start[AREA_CREATURES];
