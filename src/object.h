...
typedef enum {
	MOVEMENT_FIXED, MOVEMENT_WANDER, MOVEMENT_FOLLOW_AVATAR, MOVEMENT_ATTACK_AVATAR
} ObjectMovementBehavior;
class Object {
public: enum Type {
	UNKNOWN, CREATURE, PERSON
};
Object(Type type = UNKNOWN):tile(0), prevTile(0), movement_behavior(MOVEMENT_FIXED), objType(type), focused(false), visible(true), animated(true) {}
virtual ~Object() {}
// Methods
MapTile &getTile()
{
...
// Properties
protected: MapTile tile, prevTile;
