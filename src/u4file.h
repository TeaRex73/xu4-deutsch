...
public: static U4ZipPackageMgr *getInstance();
static void destroy();
...
class U4PATH {
public: U4PATH():defaultsHaveBeenInitd(false) {}
...
private: bool defaultsHaveBeenInitd;
};
