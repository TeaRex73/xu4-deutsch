...
goto nodownload
:download
cscript /nologo MessageBox.js "Die originale MS-DOS-Version von Ultima IV wird jetzt heruntergeladen..."
set TRY=1
:nexttry
call mirrors.bat
...
setlocal disabledelayedexpansion
cscript /nologo MessageBox.js "Herunterladen war erfolgreich! Klicke erneut auf Ultima IV, um die Dokumentation lesbar zu machen!"
exit /b 0
:error
setlocal disabledelayedexpansion
set /a TRY=%TRY% + 1
if %TRY% LEQ 10 goto :nexttry
cscript /nologo MessageBox.js "Herunterladen war nicht erfolgreich! Lade Ultima IV von https://ultima.thatfleminggent.com/ultima4.zip selbst herunter und kopiere die zip-Datei, ohne sie zu entpacken, in den Unterordner Daten!"
exit /b 1
:nodownload
...
goto nodecode
:decode
cscript /nologo MessageBox.js "Die Dokumentation wird nun lesbar gemacht..."
...
cd /d "%~dp0"
cscript /nologo MessageBox.js "Lesbarmachen war erfolgreich, bitte lies die PDF-Dateien im Ordner Ultima IV Dokumentation! Klicke nochmal auf Ultima IV, um zu spielen!"
exit /b 0
:nodecode
cd /d "%~dp0"
